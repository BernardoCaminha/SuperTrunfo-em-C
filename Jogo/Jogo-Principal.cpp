...
int main() {
	...
	char jogador1[30], jogador2[30]; //nome dos jogadores
	carta CardsJogador1[4];
	carta CardsJogador2[4];
	int PtsJogador1 = 0, PtsJogador2 = 0; // pontuacao
	...
	do {
		...
		escolha = toupper(escolha);  // escolha maiuscula
		...
		case 'S':
			...
			// distribuicao das cartas para os jogadores
			for (int i = 0; i <= 3; i++) {
